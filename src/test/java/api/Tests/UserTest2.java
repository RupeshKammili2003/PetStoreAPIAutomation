...
public class UserTest2 {
	...
	void postUserValidation() {
		...
		Response res = UserEndpoints2.post_User(userPayload);
	...
	void getUserValidation() {
		...
		Response res = UserEndpoints2.get_User(userPayload.getUsername());
		res.then().statusCode(200);
	...
	void updateUserValidation() {
		...
		Response res = UserEndpoints2.update_User(userPayload, userPayload.getUsername());
	...
	void deleteUserValidation() {
		...
		Response res = UserEndpoints2.delete_User(userPayload.getUsername());
